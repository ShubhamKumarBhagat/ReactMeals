...
const items=[{id:0, name:"Sushi",description:"Finest fish and veggies",rate:220.50},
             {id:1, name:"Schnitzel",description:"A german speciality!",rate:160.50},
             {id:2,name:"Barbecue",description:"American, raw, meaty",rate:129.99},
             {id:3,name:"Green Bowl",description:"Healty...and green...",rate:189.00}];
function App() {
